    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sleep_hours', models.DecimalField(decimal_places=1, max_digits=4, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('14'))])),
                ...
                ('screen_time_hours', models.DecimalField(decimal_places=1, max_digits=4, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('16'))])),
            ...
            options={
                'ordering': ['-date'],
                'indexes': [models.Index(fields=['user', 'date'], name='wellness_da_user_id_b9fc3d_idx')],
                'constraints': [models.UniqueConstraint(fields=('user', 'date'), name='unique_user_wellness_entry_date')],
            },
        ),
    ]
