...
CORS_ALLOWED_ORIGINS = get_list_env("CORS_ALLOWED_ORIGINS", constants.DEFAULT_CORS_ALLOWED_ORIGINS)
CSRF_TRUSTED_ORIGINS = get_list_env("CSRF_TRUSTED_ORIGINS", constants.DEFAULT_CSRF_TRUSTED_ORIGINS)
...
AUTO_START_SETUP = get_bool_env("AUTO_START_SETUP", constants.DEFAULT_AUTO_START_SETUP)
POSTGRES_DB = get_env("POSTGRES_DB", DATABASE_NAME)
POSTGRES_USER = get_env("POSTGRES_USER", DATABASE_USER)
